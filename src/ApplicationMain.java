...
public class ApplicationMain extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		app.addEventToCurrentDuration("Event Test 2", ":D :D :D", LocalDateTime.of(2001, 05, 10, 00, 00), LocalDateTime.of(2001, 06, 20, 00, 00));
		...
		app.addEventToCurrent("Event Test 5", ":)", LocalDateTime.of(2001, 11, 05, 00, 00));
		...
		app.addEventToCurrent("Event Test 19", "Last Event Test", LocalDateTime.of(2005, 8, 22, 00, 00));
